...
R = QQ[gv, v0, v02, v2, v23, v3, v13, v1, v01, gw, w0, w02, w2, w23, w3, w13, w1, w01]

I = ideal(
v3*v13*v1 - (1 - gw)^2*w1*w0*w01 - 2*gw*(1 - gw)*w1*w0 - gw^2*w1*w0*w02*w23*w13,
...
v2*v23*v3 - w3*w13*w1,
v23*v2 - (1 - gw)*w13*w3 - gw*w3,
v2*v23*v13*v1 - (1 - gw)^2*w3*w0*w13*w01 - 2*gw*(1 - gw)*w3*w0 - gw^2*w3*w0*w23*w02,
(1 - gv)*v23*v2 + gv*v2 - w3,
(1 - gv)*v13*v23*v2 + gv*v2 - (1 - gw)*w3 - gw*w23*w3,
(1 - gv)^2*v2*v0*v01*v13*v23 + 2*gv*(1 - gv)*v2*v0 + gv^2*v2*v0*v02 - w2*w23*w3,
