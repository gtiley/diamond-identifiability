...
species&tree = 8 A B C D E F G H
                 1 1 1 1 1 1 1 1
((k[&tau-parent=yes] #0.01,(C #0.01,D #0.01)u:0.01 #0.01)s:0.02 #0.01,((E #0.01,F #0.01)w:0.01 #0.01,(((A #0.01, B #0.01)t:0.01 #0.01)k[&phi=0.5,&tau-parent=no],(G #0.01,H #0.01)x:0.01 #0.01)j:0.015 #0.01)v:0.02 #0.01)r:0.03 #0.01;
