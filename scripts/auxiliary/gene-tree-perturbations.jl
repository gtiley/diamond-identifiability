...
## Global parameters
prc = 0.3 ## percentage of gene trees that will be perturbed
globalseed = 6041104 ## global seed

## Read sample of gene trees
treefile = "data/1_astral.in"
...
outfile = string(rootname,"-root-changed.out")
writeMultiTopology(trees, outfile)
...
# Write down the new sample of gene trees (some perturbed)
rootname = split(treefile, '.')[1]
outfile = string(rootname,"-nni.out")
writeMultiTopology(trees, outfile)